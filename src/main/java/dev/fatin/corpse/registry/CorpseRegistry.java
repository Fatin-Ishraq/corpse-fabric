...
public final class CorpseRegistry {
    ...
    public static final MenuType<CorpseMenu> CORPSE_MENU = Registry.register(
            ...
            id("corpse_inventory"),
            new ExtendedMenuType<>(CorpseMenu::fromNetwork, ByteBufCodecs.VAR_INT)
    );

    public static final MenuType<HistoryMenu> HISTORY_MENU = Registry.register(
            BuiltInRegistries.MENU,
            id("death_history_items"),
            new ExtendedMenuType<>(HistoryMenu::fromNetwork, HistoryScreenData.STREAM_CODEC)
    );
    ...
    public static Identifier id(String path) {
        return Identifier.fromNamespaceAndPath(CorpseFabric.MOD_ID, path);
    }
